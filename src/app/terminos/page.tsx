...
export default function TerminosPage() {
  ...
  const cargarPaginaTerminos = async () => {
    try {
      ...
      // Buscar la página de términos
      const paginaTerminos = result.data.find((p: PaginaLegal) => p.slug === 'terminos');
      
      if (!paginaTerminos) {
        setError('No se encontró la página de términos y condiciones');
        return;
      }
        ...
        <div className="mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900">
              Términos y Condiciones {isEmpresa ? 'Empresariales' : ''}
            </h1>
          </div>
