...
export default function AtencionPage() {
  ...
  useEffect(() => {
    console.log('🔄 useEffect de renderizado - servicios:', serviciosAdicionales.length);
    console.log('🔄 useEffect de renderizado - productos:', productosAdicionales.length);
  ...
  const guardarServiciosProductosAdicionales = async () => {
    ...
    try {
      ...
      console.log('✅ Servicios y productos adicionales guardados en BD');
    } catch (error) {
          ...
          <div className="bg-white p-6">
            ...
            <div className="border-t border-b py-4 mb-4">
              <div className="text-sm space-y-1">
                <div><strong>Fecha:</strong> {new Date(ticketData.fecha_emision).toLocaleString('es-MX')}</div>
